...
function CvssGauge ({ data }: Readonly<Props>) {
    ...
    return (
    <div className="bg-gray-800 w-[150px] aspect-[2.5] overflow-hidden">
        <div className="relative flex items-center justify-center bg-gray-800">
            ...
            <div className="absolute bottom-1 w-full truncate text-center text-2xl">{data.base_score}</div>
            <div className="absolute bottom-0 w-full truncate text-center text-xs">{data.author}</div>
        </div>
    </div>
    );
}
