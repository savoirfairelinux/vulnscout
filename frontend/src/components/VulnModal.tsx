...
import { faBox, faPenToSquare, faTrash } from "@fortawesome/free-solid-svg-icons";
    ...
    const saveEditedAssessment = async (data: EditAssessmentData) => {
        ...
        if (assessmentIndex !== -1) {
            ...
            const updatedAssessment = {
                ...vuln.assessments[assessmentIndex],
                status: data.status,
            ...
            // Update simplified_status based on new status
            ...
            if (STATUS_VEX_TO_GRAPH[data.status]) {
                updatedAssessment.simplified_status = STATUS_VEX_TO_GRAPH[data.status];
            }
            ...
            showMessage("Error: Assessment not found", "error");
        }
                                ...
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    {isEditing && (
                                        ...
                                        <button
                                            ...
                                            className="ml-2 px-3 py-1 text-sm rounded-lg bg-blue-600 hover:bg-blue-700 text-white"
                                        >
                                            Custom vector
                                        </button>
