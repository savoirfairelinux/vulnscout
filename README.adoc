...
[source,shell]
----
./vulnscout --project demo --variant x86 --add-spdx $(pwd)/.vulnscout/example/spdx3/core-image-minimal-qemux86-64.rootfs.spdx.json \
--add-cve-check $(pwd)/.vulnscout/example/spdx3/core-image-minimal-qemux86-64.rootfs.json
----
...
[source,shell]
----
./vulnscout --project demo --add-spdx .vulnscout/example/spdx3/core-image-minimal-qemux86-64.rootfs.spdx.json --perform-grype-scan
----
...
# Register a custom template permanently in the container
./vulnscout --add-report-template /path/to/my-custom-report.adoc
