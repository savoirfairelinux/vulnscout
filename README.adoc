...
This project contains default usage examples of VulnScout.
You can run the demo with the following command:

[source,shell]
----
./vulnscout.sh --name demo --sbom $(pwd)/.vulnscout/example/input/core-image-minimal-qemux86-64.spdx.tar.zst \
--cve-check $(pwd)/.vulnscout/example/input/core-image-minimal-qemux86-64.rootfs.json
----

Or, if you prefer to run the SPDX-3.0 example, you can use:
...
These commands will start VulnScout and open the web interface at http://localhost:7275
