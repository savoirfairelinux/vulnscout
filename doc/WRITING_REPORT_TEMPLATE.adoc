...
When generating a report after a `--match-condition` run, `unfiltered_vulnerabilities` and `unfiltered_assessments` give access to the full dataset, bypassing any active filter. Useful for summary counts.
