...
SET yocto_description = yocto_observations.description
FROM (
    SELECT vulnerability_id, description
    FROM sbom_observation
    WHERE key = "Yocto Description"
) as yocto_observations
WHERE id = yocto_observations.vulnerability_id
""")
